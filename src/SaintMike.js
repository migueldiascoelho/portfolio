...
const SaintMike2 = () => {
  ...
  return (
    <div>
      ...
      <p className="saintmike-text">
        3 years later, with more than 17,000 Youtube subscribers, a profitable business that adapts well to trends, +1,000 song credits among which: collaborations with renowned artists like "Violent Vira", "Slump6s", "Tana", or "Sqwore", as well as close contact with other Major Artists, and even events like the Vancouver Fashion Week S/S 2023, I feel like the effort was well worth it!
      </p>
      <p className="saintmike-text">
